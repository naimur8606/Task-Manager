        ...
        <div className="">
            <div className="banner flex flex-col md:flex-row items-center py-10">
                <div className="space-y-4 pl-5">
                    ...
                    <Link to="/dashboard" className="px-4 inline-block py-2 w-fit rounded-full bg-gradient-to-br from-red-600 to-gray-600 hover:from-gray-600  hover:shadow-red-100 hover:shadow-md text-xl text-white mt-3">
                        Let's Explore
                    </Link>
                </div>
